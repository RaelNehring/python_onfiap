...
while opcao>0 and opcao<3:
    if opcao==1:
        ...
        with open("D:\\[01 Rael Nehring]\\GitHub_RaelNehring\\python_onfiap\\modulo04\\aula07\\inventario_json.json", "w") as arq_json:
            json.dump(inventario, arq_json)
        print("JSON gerado!!!!")
    elif opcao==2:
        with open("D:\\[01 Rael Nehring]\\GitHub_RaelNehring\\python_onfiap\\modulo04\\aula07\\inventario_json.json", "r") as arq_json:
